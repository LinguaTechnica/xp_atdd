...
describe('Get Quote Feature', () => {
    ...
    describe('Given I am at the get quote page',()=> {
        ...
        describe('When I fill out my home address and service type', () => {
            it('Then I can see a price quote for the service I chose',  () => {
        ...
        describe('When I leave my home address incomplete',  () => {
            it('Then I see a message to provide it',  () => {
                getQuotePage.serviceType = 'Home Insurance';
